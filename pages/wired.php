        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/pages/wired.php">WIRED</a>
                    </li>
        ...
        <div class="row">
            ...
            ?>
                <div class="col">
                    ...
                    <?php $mediaURL = $entry->children('media', true)->thumbnail->attributes(); ?>
                    <img src="<?= $mediaURL->url ?>" class="rss-img" onerror="this.onerror=null; this.src='/assets/imgs/card-image.svg'" alt="...">
